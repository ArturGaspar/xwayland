...
Source0:    https://gitlab.freedesktop.org/xorg/xserver/-/archive/%{name}-%{version}/xserver-%{name}-%{version}.tar.bz2
License:    MIT
Patch0:     0001-wl_seat-patch.patch
Patch1:     0002-Revert-xwayland-non-rootless-requires-the-XDG-WM-Bas.patch
